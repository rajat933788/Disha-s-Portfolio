    ...
    >
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Social">
          <div className="flex flex-col space-y-4 text-sm">
            <HoveredLink
              href="https://github.com/agarwaldisha7616"
            ...
            <HoveredLink
              href="https://www.linkedin.com/in/agrawaldisha/"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <HoveredLink
              href="https://x.com/agarwaldisha761"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <HoveredLink
              href="https://agarwaldisha7616.github.io/landing-page/"
              rel="noopener noreferrer"
              target="_blank"
            >
